...
public class CodeGenerator {
    ...
    public static String url = "jdbc:mysql://localhost:3306/li?characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true";
    public static String username="root";
    public static String password="123456";
    //父级别包名称
    public static String parentPackage = "cn.tedu.demo1";
    //代码生成的目标路径
    public static String generateTo = "/demo1-ling/src/main/java";
    //mapper.xml的生成路径
    public static String mapperXmlPath = "/demo1-ling/src/main/resources/mapper";
    //控制器的公共基类，用于抽象控制器的公共方法，null值表示没有父类
    public static String baseControllerClassName ;// = "cn.tedu.demo1.rui.base.BaseController";
    //业务层的公共基类，用于抽象公共方法
    public static String baseServiceClassName ;   // = "cn.tedu.demo1.rui.base.BaseServiceImpl";
    //作者名
    public static String author = "tedu.cn";
    //模块名称，用于组成包名
    public static String modelName = "rui";
